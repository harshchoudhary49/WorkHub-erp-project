...
import WorkforceCommandCenter from '../pages/shared/WorkforceCommandCenter.jsx';
...
import OfficeSetup from '../pages/hr-admin/OfficeSetup.jsx';
      ...
      <Route element={<ProtectedRoute />}>
        ...
        <Route element={<DashboardLayout />}>
          ...
          <Route element={<ProtectedRoute roles={['manager', 'hr', 'admin']} />}>
            <Route path="/workforce" element={<WorkforceCommandCenter />} />
          ...
          <Route element={<ProtectedRoute roles={['hr', 'admin']} />}>
            ...
            <Route path="/hr/office-setup" element={<OfficeSetup />} />
          </Route>
        </Route>
      </Route>
