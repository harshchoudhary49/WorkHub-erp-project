...
// Exported for reuse (currently: reports.service.js). Several other
// services (leave, task, goal, performance) keep their own local copy of
// this same logic rather than importing it - not worth churning working
// code to consolidate, but new code can use this one.
export const getManagedEmployeeIds = async (managerEmployeeId) => {
